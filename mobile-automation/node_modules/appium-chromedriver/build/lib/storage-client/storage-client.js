...
class ChromedriverStorageClient {
    ...
    async unzipDriver(src, dst) {
        ...
        try {
            ...
            const chromedriverPath = await support_1.fs.walkDir(tmpRoot, true, (itemPath, isDirectory) => !isDirectory && lodash_1.default.toLower(node_path_1.default.parse(itemPath).name) === 'chromedriver');
            if (!chromedriverPath) {
